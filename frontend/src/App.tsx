...
function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      <div className="p-8">
        <h1 className="text-4xl font-bold text-white">Patos - Pay Tokens over SMS</h1>
        <p className="text-lg text-gray-300 mt-4">Application is working!</p>
      </div>
        ...
        <div className="flex items-center justify-center min-h-[calc(100vh-140px)] pt-4 sm:pt-6 lg:pt-8">
          <div className="w-full max-w-6xl mx-auto text-center space-y-6 lg:space-y-8">
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight text-patos-cream"
            >
              Pay Tokens over SMS
            </motion.h1>
            ...
            >
              Send and receive <span className="text-patos-blue font-semibold">USDC on Base</span> via 
